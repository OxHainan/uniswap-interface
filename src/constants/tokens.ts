...
export function isTenet(chainId: number): chainId is ChainId.TENET {
...
export function nativeOnChain(chainId: number): NativeCurrency | Token {
  ...
  if (isMatic(chainId)) {
    ...
    nativeCurrency = new TenetNativeCurrency(chainId)
  } else {
...
export const TOKEN_SHORTHANDS: { [shorthand: string]: { [chainId in ChainId]?: string } } = {
  USDC: {
    ...
    [ChainId.TENET]: USDC_TENET.address,
  },
}
